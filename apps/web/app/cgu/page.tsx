        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-2"><strong>Acomptes et frais de plateforme.</strong> Lorsqu&apos;un Professionnel demande un acompte à la réservation, celui-ci est encaissé pour son compte via notre prestataire de paiement Stripe. En complément de l&apos;acompte, KamerleonTech facture au Client des frais de plateforme d&apos;un montant forfaitaire de 0,49 € TTC par réservation, non facturés lorsque l&apos;acompte est inférieur à 5 €. Le montant de ces frais est affiché distinctement sur la page de paiement avant validation. Ces frais rémunèrent le service de réservation et de paiement en ligne fourni par KamerleonTech ; ils sont définitivement acquis et ne sont pas remboursés, y compris en cas d&apos;annulation donnant lieu au remboursement de l&apos;acompte par le Professionnel.</p>
            </section>
