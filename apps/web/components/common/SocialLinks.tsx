...
interface SocialLinksProps {
  size?: 'sm' | 'md';
  /** Use light colors (for dark backgrounds like CTA sections) */
...
const SOCIALS = [
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/share/18SW34WEbN',
    icon: (
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@opatam_app',
    icon: (
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@opatam_app',
    icon: (
