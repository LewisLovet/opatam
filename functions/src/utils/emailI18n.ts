  ...
  common: {
    fr: {
      ...
      labels: {
        ...
        travelFree: 'Déplacement offert',
        clientAddress: "Adresse d'intervention",
        clientAddressPending: 'Adresse complète communiquée à la confirmation',
    ...
    en: {
      ...
      labels: {
        ...
        travelFree: 'Free travel',
        clientAddress: 'Service address',
        clientAddressPending: 'Full address shared upon confirmation',
    ...
    it: {
      ...
      labels: {
        ...
        travelFee: 'Spese di trasferta',
        travelFree: 'Trasferta gratuita',
        clientAddress: "Indirizzo dell'intervento",
        clientAddressPending: 'Indirizzo completo comunicato alla conferma',
    ...
    pt: {
      ...
      labels: {
        ...
        travelFree: 'Deslocação gratuita',
        clientAddress: 'Morada da intervenção',
        clientAddressPending: 'Morada completa comunicada na confirmação',
    ...
    de: {
      ...
      labels: {
        ...
        travelFee: 'Anfahrtskosten',
        travelFree: 'Anfahrt kostenlos',
        clientAddress: 'Einsatzadresse',
        clientAddressPending: 'Vollständige Adresse nach Bestätigung',
